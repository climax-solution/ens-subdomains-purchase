...
// // File: @ensdomains/ens-contracts/contracts/ENS.sol
...
// // File: @ensdomains/ens-contracts/contracts/Deed.sol
...
// // File: @ensdomains/ens-contracts/contracts/DeedImplementation.sol
...
// // File: @ensdomains/ens-contracts/contracts/Registrar.sol
...
// // File: @ensdomains/ens-contracts/contracts/HashRegistrar.sol
...
//     function configureDomainFor(string memory name, uint[] memory price) public payable;
// }
...
//         Reserve memory reserve = reserves[subdomain];
...
//         emit NewRegistration(label, subdomain, subdomainOwner, treasury, domain.price[reserve.subscription]);
//     }
...
//     function updateListFee(uint _fee) external onlyAdmin {
//         list_fee = _fee;
//     }

//     function updateReserveFee(uint _fee) external onlyAdmin {
//         reserve_fee = _fee;
//     }
// }