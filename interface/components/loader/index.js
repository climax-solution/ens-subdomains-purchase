...
const Loader = () => (
    <div className="h-screen flex flex-col items-center">
        <Head>
            ...
            .ldio-603wa416smh-st3{fill:none;stroke-width:0.5;stroke-miterlimit:10;}
            .ldio-603wa416smh-st4{fill:none;stroke-width:0.4694;stroke-miterlimit:10;}
            `}
            </style>
        </Head>
        <svg
        ...
        >
            ...
            <g className="ldio-603wa416smh-st2">
                <path
                fill="#2accfc"
            ...
            <g>
                <polyline
                stroke="#39ff39"
                className="ldio-603wa416smh-st3"
                ...
                x={7}
                y={86}
                className="ldio-603wa416smh-st4"
                width={17}
                height={7}
                />
            </g>
